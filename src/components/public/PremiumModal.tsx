...
export function PremiumModal({ isOpen, onClose, onSuccess }: PremiumModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-md mx-4 bg-popover border border-border rounded-2xl p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
          ...
          <>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground" style={{ fontFamily: 'var(--font-body)' }}>26ª Regional Certel/Sicredi 2025</p>
              </div>
            </div>

            <p className="text-sm text-secondary-foreground mb-5 leading-relaxed" style={{ fontFamily: 'var(--font-body)' }}>
          ...
          <>
            <div className="flex flex-col items-center py-6 gap-4">
              ...
              <div className="text-center">
                <p className="text-base font-bold text-foreground mb-1" style={{ fontFamily: 'var(--font-heading)' }}>
